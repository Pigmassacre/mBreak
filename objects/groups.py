...
def empty_after_round():
	...
	Groups.projectile_group.empty()
	Groups.trajectory_group.empty()
...
class Groups:
	...
	# Define the group that contains all projectiles.
	projectile_group = pygame.sprite.Group()

	# Define the group that contains all the trajectories.
	trajectory_group = pygame.sprite.Group()
