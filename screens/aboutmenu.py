...
class AboutMenu:
	...
	def __init__(self, window_surface, main_clock, came_from_options = False):
		...
		self.pyganim_credits.set_size(8 * settings.GAME_SCALE)
		...
		self.pyganim_credits_author = textitem.TextItem("Pyganim is made by Al Sweigart")

		self.made_by_info = textitem.TextItem("Everything else made by me")

		self.made_by_author = textitem.TextItem("Olof Karlsson AKA Pigmassacre")
